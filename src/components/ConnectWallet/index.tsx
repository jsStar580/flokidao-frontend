...
const ConnectWallet = () => {
    ...
    return (
        <>{
            (currentAddr && currentAddr != "") && <Button size="md" colorScheme="blue" variant="solid" bgColor="#5c82a547">
                {
            ...
            {
                (!currentAddr || currentAddr == "") && <Button onClick={connectWalletPressed} size="md" colorScheme="blue" variant="solid" bgColor="#5c82a547">
                    Connect Wallet
                </Button>
            }
        </>
